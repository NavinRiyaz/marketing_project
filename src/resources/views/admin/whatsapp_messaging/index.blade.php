			                    ...
			                    <tr class="@if($loop->even) table-light @endif">
				                    <td data-label="{{ translate('#')}}">
				                     ...
				                     <td data-label="{{ translate('User')}}">
				                     	@if($smsLog->user_id)
				                    		<a href="{{route('admin.user.details', $smsLog->user_id)}}" class="fw-bold text-dark">{{__($smsLog->user->email)}}</a>
				                    	@else
				                    ...
				                    <td data-label="{{ translate('Sender')}}">
                                         ...
                                         {{ translate('WhatsApp Gateway')}} <i class="las la-arrow-right"></i> <span class="text--success fw-bold">{{ucfirst($smsLog->whatsappGateway->name)}}</span>
				                    	@endif
				                    </td>
